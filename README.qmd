...
2.  I want these hexagons to be 20 cm wide, but if the hexagon is in a border, it should be 19, to leave a gap between the isolated hexagons and the solid parts of the panel.
